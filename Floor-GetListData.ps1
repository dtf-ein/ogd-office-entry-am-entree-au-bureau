# Export all Floor list items to a Floor.csv file.
# These can then be imported using ./Floor-ApplyListData.ps1.
...
$ListName = "Floor"
$CSVFields=@("Title","BuildingID","FloorEnglishText","FloorFrenchText","FloorSortOrder","Capacity","CurrentCapacity","DefaultCapacityPortion","ModifiedCapacityFlag","ChangeReason");
